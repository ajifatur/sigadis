...
<body>
    ...
    <table class="tabel-form">
        ...
        <tr>
            ...
            <td></td>
            <td>d.</td>
            <td>bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, huruf b, dan huruf c, perlu menetapkan Keputusan tentang Penjatuhan Hukuman Disiplin {{ ucwords($kephukdis->hukdis->nama) }};</td>
        </tr>
        <tr>
            <td>Mengingat</td>
            <td>:</td>
    ...
    <table class="tabel-form">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                Menjatuhkan hukuman disiplin berupa {{ ucwords($kephukdis->hukdis->nama) }} kepada:<br>
                <table class="tabel-form">
                    <tr>
                        <td width="80">Nama</td>
                        <td width="5">:</td>
