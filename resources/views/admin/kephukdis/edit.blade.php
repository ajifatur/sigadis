                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="tanggal_pelanggaran" class="form-control form-control-sm {{ $errors->has('tanggal_pelanggaran') ? 'border-danger' : '' }}" value="{{ $kephukdis->tanggal_pelanggaran != null ? date('d/m/Y', strtotime($kephukdis->tanggal_pelanggaran)) : '' }}" autocomplete="off">
