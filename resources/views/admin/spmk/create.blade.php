...
@section('title', 'Tambah Surat Panggilan Menerima Hukdis')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Surat Panggilan Menerima Hukdis</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.spmk.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="tanggal_menghadap" class="form-control form-control-sm {{ $errors->has('tanggal_menghadap') ? 'border-danger' : '' }}" value="{{ old('tanggal_menghadap') }}" autocomplete="off">
                                <span class="input-group-text"><i class="bi-calendar2"></i></span>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="jam_menghadap" class="form-control form-control-sm {{ $errors->has('jam_menghadap') ? 'border-danger' : '' }}" value="{{ old('jam_menghadap') }}" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="tempat_menghadap" class="form-control form-control-sm {{ $errors->has('tempat_menghadap') ? 'border-danger' : '' }}" value="{{ old('tempat_menghadap') }}">
    ...
    $(window).on("load", function() {
        $.ajax({
            ...
            success: function(response) {
                ...
                $("select[name=menghadap_kepada]").val("{{ old('menghadap_kepada') }}");
            }
        });
