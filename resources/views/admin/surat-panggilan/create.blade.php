            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.surat-panggilan.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_atasan" id="status-atasan-1" value="1" {{ old('status_atasan') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="status-atasan-1">Atasan Langsung</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_atasan" id="status-atasan-2" value="2" {{ old('status_atasan') == '2' ? 'checked' : '' }}>
