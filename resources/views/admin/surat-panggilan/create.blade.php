...
@section('title', 'Tambah Surat Panggilan')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Surat Panggilan</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.surat-panggilan.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="panggilan" id="panggilan-1" value="1" {{ old('panggilan') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="panggilan-1">Panggilan I</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="panggilan" id="panggilan-2" value="2" {{ old('panggilan') == '2' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="jam" class="form-control form-control-sm {{ $errors->has('jam') ? 'border-danger' : '' }}" value="{{ old('jam') }}" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="tempat" class="form-control form-control-sm {{ $errors->has('tempat') ? 'border-danger' : '' }}" value="{{ old('tempat') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status-2" value="2" {{ old('status') == '2' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="pelanggaran" class="form-control form-control-sm {{ $errors->has('pelanggaran') ? 'border-danger' : '' }}" rows="3">{{ old('pelanggaran') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="atasan" id="atasan-1" value="1" {{ old('atasan') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="atasan-1">Atasan Langsung</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="atasan" id="atasan-2" value="2" {{ old('atasan') == '2' ? 'checked' : '' }}>
